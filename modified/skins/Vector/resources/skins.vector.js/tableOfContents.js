...
//////////////////////////////////////////////
// JW this section added for debugging Book TOC mod
//
...
// 		children: Array.from(element.children).map(extractSectionData)
// 	};
// }
// let tocData = expandedSections.map(extractSectionData);
// // Convert to JSON format
// let jsonText = JSON.stringify(tocData, null, 2);
// // this bit outputs the structure to the console
// console.log("// JW TOC structure\n" + jsonText);
// // this bit automatically downloads the structure to a file, toc_structure.json
// // Create a downloadable JSON file
// let blob = new Blob([jsonText], { type: "application/json" });
// let link = document.createElement("a");
// link.href = URL.createObjectURL(blob);
// link.download = "toc_structure.json";
